<?php
/*
Copyright (c) 2005 2006, Alex Tingle.  $Revision: 242 $
...
class ec3_Options
{
  ...
  function ec3_Options()
  {
    ...
    $this->myfiles=get_settings('siteurl').'/wp-content/plugins/eventcalendar3';
  ...
  {
    $this->navigation=intval(get_settings('ec3_navigation'));
  }
